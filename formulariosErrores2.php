...
<body>
    ...
    <form method="post" action="formulariosErrores2.php">

        <label for="nombre">Nombre: </label><input type="text" name="nombre" id="nombre"
            value="<?php if(isset($_POST["nombre"])) echo $_POST["nombre"];?>" />
        <?php if(isset($_POST["btnenviar"]) && $error_nombre)
		{
			echo "<span class='errores'>* Campo obligatorio *</span>";
		}
        ...
        <select id="nacido" name="nacido">
            ...
            <!-- PODEMOS AÑADIR LOS OPTION MANUALMENTE -->
      ...
      ?>
        ...
        <input id="hombre" type="radio" name="sexo" value="Hombre" checked
        ...
        <input id="deportes" type="checkbox" name="aficiones[]" value="Deportes"
            <?php if(isset($_POST["aficiones"]) && in_array('Deportes', $_POST['aficiones'])){ echo 'checked';}?> />
        <label for="lectura">Lectura</label>
        <input id="lectura" type="checkbox" name="aficiones[]" value="Lectura"
            <?php if(isset($_POST["aficiones"]) && in_array('Lectura', $_POST['aficiones'])){ echo 'checked';}?> />
        <label for="otros">Otros</label>
        <input id="otros" type="checkbox" name="aficiones[]" value="Otros"
            <?php if(isset($_POST["aficiones"]) && in_array('Otros', $_POST['aficiones'])){ echo 'checked';}?> />
